...
class SessionVault {
  // SharedPreferences keys — unique stk.* prefix
  static const _kMode         = 'stk.gate.mode';
  static const _kPushCooldown = 'stk.gate.push.cooldown';
  static const _kPushConsent  = 'stk.gate.push.consent';
  // SecureStorage keys
  static const _kSavedUrl     = 'stk.gate.url';
  static const _kUrlTtl       = 'stk.gate.url.ttl';
  static const _kOneShotUrl   = 'stk.gate.push.oneshot';
