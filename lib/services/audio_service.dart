...
class AudioService with WidgetsBindingObserver {
  ...
  static Future<void> init(GameProgress progress) async {
    ...
    try {
      ...
      if (kDebugMode) debugPrint('AudioService: setAudioContext failed: $e');
    }
    ...
    try {
      ...
      if (kDebugMode) debugPrint('AudioService: bgm setAudioContext failed: $e');
    }
  ...
  Future<void> playBgm(Bgm bgm) async {
    ...
    try {
      ...
      if (kDebugMode) debugPrint('AudioService: bgm play failed: $e');
    }
  }
  ...
  Future<void> playSfx(Sfx sfx) async {
    ...
    try {
      ...
      if (kDebugMode) debugPrint('AudioService: sfx play failed: $e');
      player.dispose();
    }
  }
